...
SRC_B = bonus/checker_bonus.c bonus/ft_atoi.c bonus/ft_fill.c bonus/ft_list.c bonus/ft_parsing_utils.c bonus/ft_parsing.c bonus/ft_push.c bonus/ft_reverse_rotate.c bonus/ft_rotate.c bonus/ft_split.c bonus/ft_stack.c bonus/ft_strjoin.c bonus/ft_swap.c bonus/get_next_line_bonus.c bonus/get_next_line_utils_bonus.c bonus/push_swap_utils.c
OBJ_M = $(SRC_M:.c=.o)
OBJ_B = $(SRC_B:.c=.o)
CC = cc
